...
@section('content')
    <div class="box" id="box">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <form id="form-item" action="/FinishGood" method="post" class="form-horizontal" data-toggle="validator"
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                                        ...
                                                        @foreach ($products as $product)
                                                            @if ($product->category_id == 2)
                                                                <option value="{{ $product->id }}"
                                                                    data-qty="{{ $product->qty }}">{{ $product->nama }}
                                                                </option>
                                                            @endif
                                                        @endforeach
                                                    </select>
                                            ...
                                            <td>
                                                <div class="col-auto">
                                                    <input type="text" class="form-control" id="material1_stock"
                                                        disabled>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-auto">
                                                    <input type="text" class="form-control" id="material2_stock"
                                                        disabled>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="col-auto">
                                                    <input type="text" class="form-control" id="material3_stock"
                                                        disabled>
                                                </div>
                                            </td>
                                            <td>
